  ...
  return (
    <>
      ...
      <Suspense fallback="Loading...">
        <div className="mx-auto py-5 max-w-screen-2xl px-4 sm:px-10 sm:py-10 bg-black text-white">
          <div className="flex flex-col gap-y-10 divide-y-2">
            <div className="my-product-wrap">
              ...
              <div className="grid gap-1 pt-4 min-[320px]:grid-cols-2 sm:gap-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 xl:gap-2 gap-y-8">
            ...
            <div className="my-product-wrap">
              ...
              <div className="grid gap-2 pt-4 min-[320px]:grid-cols-2 sm:gap-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 xl:gap-2 gap-y-8">
